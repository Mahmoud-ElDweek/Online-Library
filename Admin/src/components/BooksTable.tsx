...
const BooksTable = () => {
  ...
  const handleMoreDetails = (bookId: string) => {
    const selectedBook = books.filter((x) => x._id === bookId)[0];
      ...
      <div className="px-4 md:px-6 xl:px-7.5 mb-4 ">
        <input
          ...
          className="
                    ...
                    bg-white text-boxdark-2 dark:text-stroke border-gray-300
          ...
          >
            <div className="grid grid-cols-6 border-stroke py-3 px-4 dark:border-strokedark sm:grid-cols-10 md:px-6 2xl:px-7.5 table">
              <div className="col-span-3 flex items-center">
                <div className="grid grid-cols-4 gap-4 sm:flex-row sm:items-center">
                  ...
                  <p className="col-span-3 text-sm text-black dark:text-white text-ellipsis overflow-hidden max-h-10 self-center pe-4">
                    {book.title}
                  </p>
                </div>
              </div>
              ...
              <div className="col-span-2 hidden items-center sm:flex">
                <p className="text-sm text-black dark:text-white truncate overflow-hidden">
                  {book.author ? book.author.name : "Author Not Provided"}
                </p>
              </div>

              <div className="col-span-2 hidden items-center sm:flex">
                <p className="text-sm text-black dark:text-white truncate overflow-hidden">
                  {book.category ? book.category.name : "Category Not Provided"}
                </p>
              </div>
            ...
            <MoreDetailsModal ref={dialog}>
              ...
              <h5 className="font-semibold py-4">
                Details for book ID: {detailedBook._id}
              </h5>
              <section className="grid grid-cols-3">
                ...
                <div className="col-span-2 ms-10">
                  ...
                  <p className="py-1">
                    ...
                    {detailedBook?.author?.name}
                  </p>
                  <p className="py-1">
                    <span className="font-semibold">Category : </span>
                    {detailedBook?.category?.name}
                  </p>
                  <p className="py-1">
